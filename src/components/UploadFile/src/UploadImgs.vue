<template>
  <div class="upload-box">
    ...
    >
      ...
      <template #file="{ file }">
        <img :src="fileBaseUrl + file.url" class="upload-image" />
...
const uploadSuccess: UploadProps['onSuccess'] = (res: any): void => {
  ...
  // 删除自身
  const index = fileList.value.findIndex((item) => item.response?.data === res.data.url)
...
const handlePictureCardPreview: UploadProps['onPreview'] = (uploadFile) => {
  viewImageUrl.value = fileBaseUrl + uploadFile.url!
